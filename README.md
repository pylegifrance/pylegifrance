...
Elle inclut :
- [Démarrage rapide](https://pylegifrance.github.io/pylegifrance/operations/getting-started/) - Installer et faire votre première requête
- [Rechercher dans les codes](https://pylegifrance.github.io/pylegifrance/operations/search-legal-code/) - Codes législatifs et réglementaires
- [Récupérer une décision](https://pylegifrance.github.io/pylegifrance/operations/fetch-case-law/) - Jurisprudence judiciaire
- [Référence API](https://pylegifrance.github.io/pylegifrance/references/client/) - Documentation technique complète
- [Architecture](https://pylegifrance.github.io/pylegifrance/concepts/architecture/) - Concepts et décisions techniques
...
Site web: [https://fredferre.com](https://fredferre.com)
